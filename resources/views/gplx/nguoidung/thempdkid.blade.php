                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form role="form" method="post" enctype="multipart/form-data">  
                            ...
                            <div class="form-group">
                                ...
                                <option value="" disabled selected>Chọn hạng xe</option>
                                   @foreach($list1 as $nt)
                                    <option value="{{$nt->hx_id}}"@if($lt->hx_id==$nt->hx_id)  selected @endif>{{$nt->hx_ten}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <!--  <option value="" disabled selected>Lớp học</option> -->
                                   @foreach($list2 as $nt)
                                            <option value="{{$nt->lhlx_id}}" @if($lt->hx_id==$nt->hx_id)  selected @endif>{{$nt->lhlx_ten}}</option>
                                    @endforeach
                                     </select>
                            </div>
                            <div class="form-group">
