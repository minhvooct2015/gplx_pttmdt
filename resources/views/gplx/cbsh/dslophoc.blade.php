						...
						<div class="bootstrap-table">
							<table class="table table-bordered">
                                ...
                                <td>{{$hx->hx_ten}}</td>
                                    ...
                                    <td>
                                        <a href="{{asset('/gplx/cbsh/sualophoc/'.$hx->lhlx_id)}}" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Sửa</a>
                                        <a href="{{asset('/gplx/cbsh/xoalophoc/'.$hx->lhlx_id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Xóa</a>
                                    </td>
                                </tr>
                                  @endforeach
				                </tbody>
